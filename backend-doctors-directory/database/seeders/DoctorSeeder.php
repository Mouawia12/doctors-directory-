    ...
    protected function createDemoDoctor($categories): void
    {
        ...
        $doctor = Doctor::updateOrCreate(
            ...
            [
                ...
                'professional_role' => 'أخصائية نفسية',
                ...
                'client_participants' => ['أفراد', 'أزواج / عائلات'],
                'client_age_groups' => ['مراهقون', 'بالغون'],
                'faith_orientation' => 'إسلامي',
                'allied_communities' => ['مجتمع الميم', 'ضعاف السمع', 'العدالة العرقية'],
                'therapy_modalities' => ['CBT', 'EMDR', 'Mindfulness', 'Intervention'],
